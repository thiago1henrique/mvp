...
export default function ProjectsSection({ activeProfile }: Props) {
  ...
  return (
    <section id="projetos" style={{ padding: '96px 0', position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Horizontal scroll — full width, breaks max-width */}
      <motion.div
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: '0 24px 64px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.02)',
        transition: 'border-color 0.25s, box-shadow 0.25s',
      }}
      whileHover={{
        borderColor: 'rgba(220,20,60,0.32)',
        boxShadow: '0 32px 80px rgba(0,0,0,0.55), 0 0 40px rgba(220,20,60,0.06)',
      }}
    >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', borderRight: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            >
              ...
              >
                <div
                  style={{
                    ...
                    borderLeft: '12px solid rgba(220,20,60,0.55)',
                    marginLeft: 3,
                  }}
                />
              </div>
              <span
                style={{
                  ...
                  color: 'rgba(220,20,60,0.45)', letterSpacing: 2.5,
          ...
          <div
            style={{
              ...
              padding: '6px 0',
              borderTop: '1px solid rgba(220,20,60,0.07)',
            }}
          >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <span
              style={{
                ...
                color: '#DC143C', letterSpacing: 2.5, textTransform: 'uppercase',
              }}
            >
              Projeto {num}
            </span>
              ...
              {project.techs.map(tech => (
                <span
                  ...
                  style={{
                    ...
                    color: '#DC143C', backgroundColor: 'rgba(220,20,60,0.08)',
            ...
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              {project.demo ? (
                <a
                  ...
                  style={{
                    ...
                    color: '#fff', backgroundColor: '#DC143C',
                    border: '1px solid #DC143C', borderRadius: 8,
              ...
              {project.github && project.demo && (
                <a
                  ...
                  onMouseEnter={e => { e.currentTarget.style.color = '#DC143C'; e.currentTarget.style.borderColor = 'rgba(220,20,60,0.35)' }}
